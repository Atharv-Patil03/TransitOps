...
export const DialogDescription: React.FC<React.HTMLAttributes<HTMLParagraphElement>> = ({
  ...
  <p className={`text-sm text-zinc-500 dark:text-zinc-400 mt-1.5 ${className}`} {...props}>
    {children}
  </p>
);
...
export const DialogFooter: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  ...
  <div className={`px-6 pb-6 pt-2 flex items-center justify-end gap-3 ${className}`} {...props}>
    {children}
  </div>
);
