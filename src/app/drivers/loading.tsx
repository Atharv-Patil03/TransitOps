  ...
  return (
    <div className="flex-1 w-full max-w-7xl mx-auto px-4 py-8 md:py-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-100 dark:border-zinc-900 pb-6 mb-8">
        <div>
          <div className="h-8 w-44 bg-zinc-200 dark:bg-zinc-800 rounded-lg animate-pulse" />
            ...
            <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800 bg-white dark:bg-zinc-950">
              {skeletonRows.map((_, idx) => (
                <tr key={idx}>
                  ...
                  <td className="px-6 py-5">
                    <div className="h-4 w-12 bg-zinc-100 dark:bg-zinc-900 rounded animate-pulse" />
                  </td>
                  <td className="px-6 py-5">
                    <div className="h-4 w-24 bg-zinc-100 dark:bg-zinc-900 rounded animate-pulse" />
                  </td>
                  <td className="px-6 py-5">
                    <div className="h-4 w-28 bg-zinc-100 dark:bg-zinc-900 rounded animate-pulse" />
                  </td>
                  <td className="px-6 py-5">
