...
export const Toast: React.FC<ToastProps> = ({
  ...
  const typeStyles: Record<"success" | "error", string> = {
    ...
    error: "bg-rose-600 border-rose-700 text-white shadow-rose-200/50 dark:shadow-none",
  };

  return (
    <div
      className={`fixed bottom-5 right-5 z-50 flex items-center gap-3 px-4.5 py-3.5 rounded-xl border shadow-lg text-sm font-medium transition-all duration-300 animate-bounce-in ${typeStyles[type]}`}
    >
      {type === "success" ? (
